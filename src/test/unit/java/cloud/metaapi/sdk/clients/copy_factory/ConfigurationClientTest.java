...
class ConfigurationClientTest {
  ...
  /**
   * Tests {@link ConfigurationClient#getAccount(String)}
   */
  @Test
  void testRetrieveCopyFactoryAccountFromApi() {
    CopyFactoryAccount expectedAccount = new CopyFactoryAccount() {{
      _id = "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef";
      name = "Demo account";
      connectionId = "e8867baa-5ec2-45ae-9930-4d5cea18d0d6";
      reservedMarginFraction = 0.25;
    ...
    httpClient.setRequestMock((actualOptions) -> {
      try {
        HttpRequestOptions expectedOptions = new HttpRequestOptions(
          copyFactoryApiUrl + "/users/current/configuration/accounts/"
          + "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef", Method.GET);
        expectedOptions.getHeaders().put("auth-token", "header.payload.sign");
        assertThat(actualOptions).usingRecursiveComparison().isEqualTo(expectedOptions);
        return CompletableFuture.completedFuture(jsonMapper.writeValueAsString(expectedAccount));
      } catch (JsonProcessingException e) {
        e.printStackTrace();
        return null;
      }
    });
    CopyFactoryAccount actualAccount = copyFactoryClient.getAccount(
   ...
   */
  @Test
  void testDoesNotRetrieveCopyFactoryAccountFromApiWithAccountToken() throws Exception {
    copyFactoryClient = new ConfigurationClient(httpClient, "token");
    try {
      copyFactoryClient.getAccount("test").get();
    } catch (ExecutionException e) {
      assertEquals(
   ...
   */
  @Test
  void testRetrievesStrategiesFromApi() throws Exception {
  ...
  /**
   * Tests {@link ConfigurationClient#getStrategy(String)}
   */
  @Test
  void testRetrievesStrategyFromApi() {
    CopyFactoryStrategy expectedStrategy = new CopyFactoryStrategy() {{
      _id = "ABCD";
      platformCommissionRate = 0.01;
      name = "Test strategy";
      positionLifecycle = "hedging";
    ...
    httpClient.setRequestMock((actualOptions) -> {
      try {
        HttpRequestOptions expectedOptions = new HttpRequestOptions(
          copyFactoryApiUrl + "/users/current/configuration/strategies/ABCD", Method.GET);
        expectedOptions.getHeaders().put("auth-token", "header.payload.sign");
        assertThat(actualOptions).usingRecursiveComparison().isEqualTo(expectedOptions);
        return CompletableFuture.completedFuture(jsonMapper.writeValueAsString(expectedStrategy));
      } catch (JsonProcessingException e) {
        e.printStackTrace();
        return null;
      }
    });
    CopyFactoryStrategy actualStrategy = copyFactoryClient.getStrategy("ABCD").join();
    assertThat(actualStrategy).usingRecursiveComparison().isEqualTo(expectedStrategy);
  }
   ...
   */
  @Test
  void testDoesNotRetrieveStrategyFromApiWithAccountToken() throws Exception {
    copyFactoryClient = new ConfigurationClient(httpClient, "token");
    try {
      copyFactoryClient.getStrategy("ABCD").get();
    } catch (ExecutionException e) {
      assertEquals(
  ...
  /**
   * Tests {@link ConfigurationClient#getPortfolioStrategy(String)}
   */
  @Test
  void testRetrievesPortfolioStrategyFromApi() {
    CopyFactoryPortfolioStrategy expectedStrategy = new CopyFactoryPortfolioStrategy() {{
      _id = "ABCD";
      platformCommissionRate = 0.01;
      name = "Test strategy";
      members = Lists.list(new CopyFactoryPortfolioMember() {{
    ...
    httpClient.setRequestMock((actualOptions) -> {
      try {
        HttpRequestOptions expectedOptions = new HttpRequestOptions(
          copyFactoryApiUrl + "/users/current/configuration/portfolio-strategies/ABCD", Method.GET);
        expectedOptions.getHeaders().put("auth-token", "header.payload.sign");
        assertThat(actualOptions).usingRecursiveComparison().isEqualTo(expectedOptions);
        return CompletableFuture.completedFuture(jsonMapper.writeValueAsString(expectedStrategy));
      } catch (JsonProcessingException e) {
    ...
    CopyFactoryPortfolioStrategy actualStrategy = copyFactoryClient.getPortfolioStrategy("ABCD").join();
    assertThat(actualStrategy).usingRecursiveComparison().isEqualTo(expectedStrategy);
  }
   ...
   */
  @Test
  void testDoesNotRetrievePortfolioStrategyFromApiWithAccountToken() throws Exception {
    copyFactoryClient = new ConfigurationClient(httpClient, "token");
    try {
      copyFactoryClient.getPortfolioStrategy("ABCD").get();
    } catch (ExecutionException e) {
      assertEquals(
